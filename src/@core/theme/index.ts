...
const notoSans = Noto_Sans_Thai({ subsets: ['thai', 'latin'], weight: ['300', '400', '500', '600', '700'] })
...
const theme = (settings: Settings, mode: SystemMode, direction: Theme['direction']): Theme => {
  return {
    ...
    typography: typography({ headingFontFamily: notoSans.style.fontFamily, bodyFontFamily: notoSans.style.fontFamily }),
