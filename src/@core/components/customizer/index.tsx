...
const getLocalePath = (pathName: string, locale: string) => {
  ...
  while (segments.length > 0 && i18n.locales.includes(segments[0] as Locale)) {
    segments.shift()
  }
                  ...
                  <div className='flex items-center gap-4'>
                    <Link href={getLocalePath(pathName, 'en')}>
                      <div className='flex flex-col items-start gap-0.5'>
                        <div
                          className={classnames(styles.itemWrapper, {
                            [styles.active]: direction === 'ltr' && locale === 'en'
                          })}
                        >
                          <DirectionLtr />
                        </div>
                    ...
                    <Link href={getLocalePath(pathName, 'th')}>
                      <div className='flex flex-col items-start gap-0.5'>
                        <div
                          className={classnames(styles.itemWrapper, {
                            [styles.active]: locale === 'th'
                          })}
                        >
                          <DirectionLtr />
                        </div>
