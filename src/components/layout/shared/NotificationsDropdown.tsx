                ...
                <div className='bs-full flex flex-col'>
                  <div className='flex items-center justify-between plb-3.5 pli-4 is-full gap-2'>
                    <Typography variant='h6' className='flex-auto'>
                      {t('dms.layout.notifications.title')}
                    </Typography>
                    {notificationCount > 0 && (
                      <Chip
                        size='small'
                        variant='tonal'
                        color='primary'
                        label={t('dms.layout.notifications.newCount').replace('{count}', String(notificationCount))}
                      />
                    )}
                    <Tooltip
                      title={readAll ? t('dms.layout.notifications.markAllUnread') : t('dms.layout.notifications.markAllRead')}
                  ...
                  <div className='p-4'>
                    <Button fullWidth variant='contained' size='small'>
                      {t('dms.layout.notifications.viewAll')}
                    </Button>
                  </div>
                </div>
              </ClickAwayListener>
