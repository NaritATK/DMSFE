...
// Constants
const pageData = [
  { titleKey: 'navigation.pricing', href: '/pricing' },
  { titleKey: 'navigation.payment', href: '/payment' },
  { titleKey: 'navigation.checkout', href: '/checkout' },
  { titleKey: 'dms.frontPagesShared.helpCenter', href: '/help-center' }
]

const authData = [
  { titleKey: 'navigation.loginV1', href: '/login-v1' },
  { titleKey: 'navigation.loginV2', href: '/login-v2' },
  { titleKey: 'navigation.registerV1', href: '/register-v1' },
  { titleKey: 'navigation.registerV2', href: '/register-v2' },
  { titleKey: 'navigation.registerMultiSteps', href: '/register-multi-steps' },
  { titleKey: 'navigation.forgotPasswordV1', href: '/forgot-password-v1' },
  { titleKey: 'navigation.forgotPasswordV2', href: '/forgot-password-v2' },
  { titleKey: 'navigation.resetPasswordV1', href: '/reset-password-v1' },
  { titleKey: 'navigation.resetPasswordV2', href: '/reset-password-v2' }
]

const othersData = [
  { titleKey: 'navigation.underMaintenance', href: '/misc/under-maintenance' },
  { titleKey: 'navigation.comingSoon', href: '/misc/coming-soon' },
  { titleKey: 'navigation.notAuthorized401', href: '/misc/401-not-authorized' },
  { titleKey: 'navigation.verifyEmailV1', href: '/auth/verify-email-v1' },
  { titleKey: 'navigation.verifyEmailV2', href: '/auth/verify-email-v2' },
  { titleKey: 'navigation.twoStepsV1', href: '/auth/two-steps-v1' },
  { titleKey: 'navigation.twoStepsV2', href: '/auth/two-steps-v2' }
]
...
const DropdownMenu = (props: Props) => {
  ...
  return (
    <Tag {...(isBelowLgScreen && { className: 'flex flex-col' })}>
      ...
      >
        <span>{t('dms.frontPagesShared.pages')}</span>
        <i
      ...
      >
        <div className='flex flex-col gap-4'>
          <div className='flex gap-3 items-center'>
            ...
            <Typography variant='h6'>{t('dms.frontPagesShared.page')}</Typography>
          </div>
        ...
        <div className='flex flex-col gap-4'>
          <div className='flex gap-3 items-center'>
            ...
            <Typography variant='h6'>{t('dms.frontPagesShared.authDemo')}</Typography>
          </div>
        ...
        {!isBelowLgScreen && (
          <div className='flex bg-backgroundDefault p-2 rounded'>
            <img
              ...
              width='385'
              alt={t('dms.frontPagesShared.dropdownImageAlt')}
              className='rounded'
            />
          </div>
        )}
