...
const FrontMenu = (props: Props) => {
  ...
  return (
    <Wrapper isBelowLgScreen={isBelowLgScreen} isDrawerOpen={isDrawerOpen} setIsDrawerOpen={setIsDrawerOpen}>
      ...
      >
        {t('dms.frontPagesShared.features')}
      </Typography>
      <Typography
        color='text.primary'
        component={Link}
      ...
      >
        {t('dms.frontPagesShared.contactUs')}
      </Typography>
      <DropdownMenu
        mode={mode}
