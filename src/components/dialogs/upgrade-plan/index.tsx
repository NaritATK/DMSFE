...
import UnsubscribeConfirmationDialog from '../confirmation-dialog/UnsubscribeConfirmationDialog'
...
const UpgradePlan = ({ open, setOpen }: UpgradePlanProps) => {
  ...
  return (
    <>
      ...
      <UnsubscribeConfirmationDialog open={openConfirmation} setOpen={setOpenConfirmation} />
    </>
  )
}
