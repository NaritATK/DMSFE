...
const getSteps = (t: any) => [
  { title: t('dms.authTemplates.stepAccount'), icon: 'tabler-file-analytics', subtitle: t('dms.authTemplates.stepAccountSubtitle') },
  { title: t('dms.authTemplates.stepPersonal'), icon: 'tabler-user', subtitle: t('dms.authTemplates.stepPersonalSubtitle') },
  { title: t('dms.authTemplates.stepBilling'), icon: 'tabler-credit-card', subtitle: t('dms.authTemplates.stepBillingSubtitle') }
]
