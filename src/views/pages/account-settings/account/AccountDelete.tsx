...
// Component Imports
import DeleteAccountConfirmationDialog from '@components/dialogs/confirmation-dialog/DeleteAccountConfirmationDialog'
    ...
    <Card>
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <DeleteAccountConfirmationDialog open={open} setOpen={setOpen} />
        </form>
      </CardContent>
    </Card>
  )
