    ...
    <section className={classnames('-mbs-[18%] sm:mbs-[-10%] lg:mbs-[-5%] md:mbs-[-8%]', styles.bgImage)}>
      ...
      >
        <Typography variant='h4' color='primary.main'>
          {t('dms.frontPages.helpCenter.header.title')}
        </Typography>
        <CustomTextFieldStyled
          className='is-full sm:max-is-[55%] md:max-is-[465px]'
          placeholder={t('dms.frontPages.helpCenter.header.searchPlaceholder')}
          value={searchValue}
        ...
        />
        <Typography>{t('dms.frontPages.helpCenter.header.subtitle')}</Typography>
      </div>
    </section>
  )
}
