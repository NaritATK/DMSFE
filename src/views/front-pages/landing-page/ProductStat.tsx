...
const statData: StatData[] = [
  {
    titleKey: 'dms.frontPages.landing.productStat.supportTicketsResolved',
    value: '7.1k+',
  ...
  {
    titleKey: 'dms.frontPages.landing.productStat.joinCreativesCommunity',
    value: '50k+',
  ...
  {
    titleKey: 'dms.frontPages.landing.productStat.highlyRatedProducts',
    value: '4.8/5',
  ...
  {
    titleKey: 'dms.frontPages.landing.productStat.moneyBackGuarantee',
    value: '100%',
            ...
            <Grid key={index} size={{ xs: 12, sm: 6, md: 3 }}>
              ...
              >
                ...
                <div className='text-center'>
                  ...
                  <Typography className='font-medium'>{t(stat.titleKey)}</Typography>
                </div>
              </div>
            </Grid>
          ))}
