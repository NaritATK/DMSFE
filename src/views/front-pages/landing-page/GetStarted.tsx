...
const GetStarted = ({ mode }: { mode: SystemMode }) => {
  ...
  return (
    <section className='relative'>
      <img
        src={getStartedImage}
        alt={t('dms.frontPages.landing.getStarted.backgroundAlt')}
